 ...
 *
 * Менеджер оценивает лид результатом разговора, а не абстрактной «работой»:
 * не дозвонился, думает, записался на урок, отказал. Набор ровно тот, что у
 * кнопок бота, — и это главное правило здесь. Пока в кабинете жили лишние
 * «Дозвон» и «В работе», нажать их было негде, а одна и та же заявка в двух
 * местах называлась по-разному. Появляется новый статус — он появляется
 * одновременно и в списке, и в кнопках, или не появляется вовсе.
 *
